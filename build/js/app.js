...
//=include lib/jquery.lemongrab.js
$(document).ready(function() {
	...
	function minifyLogo() {
		if (win.scrollTop() > 5) {
			logo.removeClass('header__logo_big');
		} else {
			logo.addClass('header__logo_big');
		}
	}

	if (window.innerWidth > 1365) {
		win.on('scroll', minifyLogo);
		enabled = true;
	}
